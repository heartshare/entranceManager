...
namespace app\library\zkteco;

use ErrorException;
use Exception;
use app\library\zkteco\Helper\Attendance;
use app\library\zkteco\Helper\Device;
use app\library\zkteco\Helper\Face;
use app\library\zkteco\Helper\Fingerprint;
use app\library\zkteco\Helper\Os;
use app\library\zkteco\Helper\Pin;
use app\library\zkteco\Helper\Platform;
use app\library\zkteco\Helper\SerialNumber;
use app\library\zkteco\Helper\Ssr;
use app\library\zkteco\Helper\Time;
use app\library\zkteco\Helper\User;
use app\library\zkteco\Helper\Util;
use app\library\zkteco\Helper\Connect;
use app\library\zkteco\Helper\Version;
use app\library\zkteco\Helper\WorkCode;
...
class ZKTeco
{
     ...
     * @param int $timout
     */
    public function __construct(string $ip, int $port = 4370, int $timout = 5)
    {
        $this->_ip = $ip;
        $this->_port = $port;
     ...
     */
    public function getAttendance(string $deviceModel)
    {
        return Attendance::get($this, $deviceModel);
    }
